<template>
  <div id="post-reader">
    ...
    <div class="post" v-for="post in posts" v-else>
      ...
      <div class="content" >
        <div class="nav-history"><a href="https://mechatronik-group.com/">Inicio</a> &#10095 <a href="https://mechatronik-group.com/casos-de-exito">casos-de-exito</a> &#10095 {{post.title.rendered}}</div>
...
export default {
  ...
  mounted: async function() {
      try {
        ...
        var consulta;
        consulta = 'https://blog.mechatronik-group.com/wp-json/wp/v2/posts?categories=43&slug=';
