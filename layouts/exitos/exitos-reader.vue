<template>
  <div id="post-reader">
    ...
    <div class="post" v-for="post in posts" v-else>
      ...
      <div class="content" >
        <p class="nav-history"><a href="https://mechatronik-group.com/">Inicio</a> &#10095 <a href="https://mechatronik-group.com/casos-de-exito">casos-de-exito</a> &#10095 {{post.title.rendered}}</p>
