<template>
  <div id="post-reader">
    ...
    <div class="post" v-for="post in posts" v-else>
      ...
      <div class="content" >
        <div class="nav-history"><a href="https://mechatronik-group.com/">Inicio</a> &#10095 <a href="https://mechatronik-group.com/servicios">Servicios</a> &#10095 {{post.title.rendered}}</div>
